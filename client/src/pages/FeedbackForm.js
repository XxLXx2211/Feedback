    ...
    const loadData = async () => {
      try {
        ...
        if (isEditMode) {
          ...
          if (feedbackData.preguntas_seleccionadas && feedbackData.preguntas_seleccionadas.length > 0) {
            const questionIds = feedbackData.preguntas_seleccionadas.map(q => q._id);
