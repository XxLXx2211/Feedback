...
app.use('/api/monitor', monitorRoutes); // No requiere verificación de BD para endpoints básicos
...
app.get('/api', (req, res) => {
  ...
  res.json({
    ...
    version: '1.1.0', // Versión actualizada con optimizaciones
    endpoints: [
      '/api/companies',
      '/api/employees',
      '/api/questions',
    ...
    optimizations: [
      ...
      'Conexiones de base de datos mejoradas'
    ]
  });
});
